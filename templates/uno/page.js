...
var insertStatement = "INSERT INTO Contacts (username, useremail) VALUES ('Carlo Carlo', 'carlo.zanieri@tim.it')";
...
var dropStatement = "DROP TABLE Contacts";
 ...
 var db = openDatabase("AddressBook", "3.49.1", "Address Book", 200000);  // Open SQLite Database
...
;
    ...
    $("#btnReset").click(selectAllStatement);
